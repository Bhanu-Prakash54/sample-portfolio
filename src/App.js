...
class App extends Component {
  ...
  getFilteredProjectsList = () => {
    ...
    const fiteredList = projectsList.filter(
  ...
  render() {
    const {activeTabId} = this.state
    const fiteredList = this.getFilteredProjectsList()
    ...
    return (
      <div className="app-container">
        ...
        <ul className="tabs-container">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              updateFilteredProjectsList={this.updateFilteredProjectsList}
        ...
        <ul className="project-list-container">
          {fiteredList.map(projectDetails => (
            <ProjectItem
